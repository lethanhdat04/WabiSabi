...
/**
 * Repository for DictationAttempt entity operations.
 */
@Repository
interface DictationAttemptRepository : MongoRepository<DictationAttempt, String> {

    /**
     * Find all attempts by user with pagination.
     */
    fun findByUserId(userId: String, pageable: Pageable): Page<DictationAttempt>

    /**
     * Find attempts by user and video.
     */
    fun findByUserIdAndVideoId(userId: String, videoId: String): List<DictationAttempt>
     ...
     */
    fun findTop10ByUserIdOrderByCreatedAtDesc(userId: String): List<DictationAttempt>
